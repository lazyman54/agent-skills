...
> 仅「修改已有用例」时升版本并记一行；「新增用例」直接追加章节、不升版本。

| 版本 | 日期 | 变更 | commit |
|---|---|---|---|
| v1 | 2026-05-29 | 初版（2.1/2.2 基础 + 3.1~3.7 业务）| `a1b2c3` |
| v2 | 2026-06-02 | 3.2 幂等命中预期由「返回 Code=9999」改为「返回原 orderID + Code=IdempotentHit」（BUG3 修复后逻辑变更）| `d4e5f6` |
